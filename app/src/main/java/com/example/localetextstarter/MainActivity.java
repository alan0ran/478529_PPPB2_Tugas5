...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText priceEach;
    private TextView pricePacks;
    Button submitButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceEach = findViewById(R.id.price_each);
        pricePacks = findViewById(R.id.price_packs);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(priceEach.getText().toString().length() == 0) {
                    pricePacks.setText("0");
                }
                else {
                    int price = Integer.parseInt(priceEach.getText().toString());
                    int priceTotal = price * 100;

                    pricePacks.setText(String.valueOf(priceTotal));
                }
            }
        });
    }
